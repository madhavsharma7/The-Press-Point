        ...
        <div id="container">
            ...
            <div id="footersss">
                <div className="navbar-items-footersss">
                    <p className="footersss-logo">The Press Point</p>
                    <p className="footersss-copyright">&copy; 2025 The Press Point All Rights Reserved</p>
                </div>
            </div>
        </div>
    );
